            ...
            <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
              <div className="w-full space-x-12 flex justify-center text-gray-300 sm:w-7/12 md:justify-start">
                ...
                <div className='flex gap-6'>
                  ...
                  <li>
                    <a href="https://github.com" target='_blanck' className="flex items-center space-x-3 hover:text-sky-400 transition">
                  ...
                  <li>
                    <a href="https://twitter.com" target='_blanck' className="flex items-center space-x-3 hover:text-sky-400 transition">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-5" viewBox="0 0 16 16">
                  ...
                  <li>
                    <a href="https://youtube.com" target='_blanck' className="flex items-center space-x-3 hover:text-sky-400 transition">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-5" viewBox="0 0 16 16">
                  ...
                  <div className='space-y-8'> 
                  <li>
                    <a href="https://facebook.com" target='_blanck' className="flex items-center space-x-3 hover:text-sky-400 transition">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-5" viewBox="0 0 16 16">
                  ...
                  <li>
                    <a href="https://instagram.com" target='_blanck' className="flex items-center space-x-3 hover:text-sky-400 transition">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-5" viewBox="0 0 16 16">
